...
public class LuxuryDetialsActivity extends BaseActivity {
	...
	//豪车详情信息
	private LuxuryContentInfos contentInfos;
	...
	public void onClick(View v) {
		...
		case R.id.luxury_details_order:
			intent = new Intent(LuxuryDetialsActivity.this,
	...
	public void init(Bundle savedInstanceState) {
		...
		String title = bundle.getString("luxury_details");
		...
		//获取豪车详情信息
		getLuxuryContentInfo(mcarid);
		
		//信息显示:写在这里会空指针异常？？？？？
		//showLuxuryContentInfo();
	}
	
	private void showLuxuryContentInfo() {
		// TODO Auto-generated method stub
	...
	private void getLuxuryContentInfo(final String mcarid) {
		// TODO Auto-generated method stub
		...
		public void onSuccess(ResponseInfo<String> arg0) {
			...
			contentInfos = JSON.parseObject(json, LuxuryContentInfos.class);
			showLuxuryContentInfo();
		}
	});
	}
	...
	private void initPoint() {
		...
		for (int i = 0; i < images.length; i++) {
			View view = new View(LuxuryDetialsActivity.this);
			paramsL.setMargins(YangUtils.dip2px(LuxuryDetialsActivity.this, 5),
					0, 0, 0);
	...
	private class MyPageAdapter extends PagerAdapter {
		...
		public Object instantiateItem(ViewGroup container, final int position) {
			...
			View view = View.inflate(LuxuryDetialsActivity.this,
