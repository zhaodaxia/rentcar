...
public class SelectFollowBrandActivity extends MyBaseActivity {
	...
	private void initViews() {
		...
		sortListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				String Follow_carbrand_name =  adapter.getItem(position).carbrand_name;
				String Follow_carbrandid =  adapter.getItem(position).carbrandid;
				intent = new Intent();
				intent.putExtra("Follow_carbrand_name", Follow_carbrand_name);
		...
		MyApplication.httpUtils.send(HttpMethod.POST, HttpUrl.CAR_BRAND,params, new RequestCallBack<String>() {
			...
			public void onSuccess(ResponseInfo<String> arg0) {
				...
				adapter = new SelectCarBrandListViewAdapter(
						SelectFollowBrandActivity.this, SourceDateList);
