...
public class UseCarStandardListViewAdapter extends BaseAdapter {
	private LayoutInflater inflater;
	public final static String[] tv = {"不限","豪华轿车","高端轿车","其他车型"};
	
	
	public UseCarStandardListViewAdapter(Context context){
