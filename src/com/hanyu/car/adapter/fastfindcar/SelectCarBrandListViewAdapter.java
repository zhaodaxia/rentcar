...
import com.hanyu.car.ui.silent.handle.ImageLoader;
 ...
 * @author
 */
public class SelectCarBrandListViewAdapter extends BaseAdapter implements
		SectionIndexer {
	private List<CarBrand> list = null;
	private Context mContext;
	public ImageLoader imageLoader;

	public SelectCarBrandListViewAdapter(Context mContext, List<CarBrand> list) {
	...
	public View getView(final int position, View view, ViewGroup arg2) {
		...
		if (view == null) {
			...
			view = LayoutInflater.from(mContext).inflate(
					R.layout.index_item_adapter, null);
		...
		viewHolder.tvTitle.setText(this.list.get(position).carbrand_name);
