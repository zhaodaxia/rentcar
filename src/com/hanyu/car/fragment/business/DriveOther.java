...
public class DriveOther extends BaseFragment {
	...
	public void initData(Bundle savedInstanceState) {
		...
		ptr_item.getRefreshableView().setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				intent.putExtra("driveself_details", myadapter.getItem(position).toString());
	...
	private void getDriveData() {
		...
		params.addBodyParameter("bus_cid", "2");
		MyApplication.httpUtils.send(HttpMethod.POST, HttpUrl.BUSINESS_LIST, params, new RequestCallBack<String>() {
			...
			public void onSuccess(ResponseInfo<String> arg0) {
				...
				List<BusinessInfo> infos = JSON.parseArray(json, BusinessInfo.class);
